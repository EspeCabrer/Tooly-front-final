...
function Filter(props) {
  ...
  useEffect(
    () => {
      if (userInfo) {
        ...
        let dummyUser = {
          data: {
            _id: "615f0a4b5e7a9b0016302795",
            address: { street: "Pamplona", number: "96", city: "Barcelona" },
            email: "tooly.project@gmail.com",
            favorites: [],
            location: { lat: "41.3979343", lng: "2.190108" },
            password:
              "$2a$10$y7HjulCcLJFrgD10lhLBieuP5z3aOYtwlsguVeeUEC.yC41a8PHg.",
            products: [],
            transactions: [],
            username: "Dummy User",
          },
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(API_URL + "/product/filter", objectToSubmit).then((response) => {
